...
router.post('/branch-availability', async (req, res) => {
    try {
        ...
        const updated = await catalogService.setProductAvailabilityInBranch(branchId, productId, isAvailable, outOfStockReason, customPrice);
